...
![4.png](pic/4.png)
### 实验与分析
&emsp;&emsp;经测试，本设计可以较为准确的识别出公式位置并提取出Latex表达式，其效果如下：![5.png](5.png)
